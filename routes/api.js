...
var asahotak = require('./../lib/utils/asahotak');
var tebakkimia = require('./../lib/utils/tebakkimia');
...
router.get('/maker/ttp2', async (req, res, next) => {
  ...
  if(listkey.includes(Apikey)) {
  random = new Date
data = await fetch(`https://api.xteam.xyz/attp?file&text=${encodeURIComponent(req.query.text)}`).then(v => v.json())
         base64 = data.base64
